...
namespace OpenRA.Mods.Common.AI.Esu.Activities
{
    public class MoveToward : Activity
    {
        ...
        public MoveToward(Actor self, Target target)
		{
			Target = target;
		...
		public override Activity Tick(Actor self)
		{
			...
			if (inner == null)
			{
                ...
                inner = mobile.MoveTo(() => CalculatePathToTarget(self, CandidateMovementCells(self)));
				repath = false;
			}
		...
		List<CPos> CalculatePathToTarget(Actor self, IEnumerable<CPos> targetCells)
		{
            ...
            if (!searchCells.Any()) {
                targetCells = Util.ExpandFootprint(targetCells, true);
                return CalculatePathToTarget(self, targetCells);
            }
